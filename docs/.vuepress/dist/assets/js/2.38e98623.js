  ...
  Array(232).concat([
      ...
      function p(t, e, n) {
        ...
        for (let e = 0; e < t.length; e++)
          if (o(t[e].regularPath) === i)
            return Object.assign({}, t[e], { type: 'page', path: f(t[e].path) })
        return console.error(`[vuepress] No matching page found for sidebar item "${e}"`), {}
      }
      function d(t, e, n, i) {
        const { pages: r, themeConfig: a } = n,
    ...
    function(t, e, n) {
      ...
      var i = n(11),
        ...
        a = n(126),
        s = n(127)
      n(128)('match', 1, function(t, e, n, o) {
        return [
          function(n) {
            var i = t(this),
              r = null == n ? void 0 : n[e]
          ...
          function(t) {
            ...
            for (var f, h = [], p = 0; null !== (f = s(u, c)); ) {
              var d = String(f[0])
              ;(h[p] = d), '' === d && (u.lastIndex = a(c, r(u.lastIndex), l)), p++
            }
            return 0 === p ? null : h
          }
        ]
    ...
    function(t, e, n) {
      ...
      var i = n(11),
        ...
        h = /\$([$&`']|\d\d?|<[^>]*>)/g,
        p = /\$([$&`']|\d\d?)/g
      n(128)('replace', 2, function(t, e, n, d) {
        return [
          function(i, r) {
            var a = t(this),
              s = null == i ? void 0 : i[e]
          ...
          function(t, e) {
            ...
            for (var b = []; ; ) {
              ...
              if (null === _) break
              if ((b.push(_), !v)) break
              '' === String(_[0]) && (f.lastIndex = o(h, a(f.lastIndex), m))
            }
            for (var k, x = '', y = 0, $ = 0; $ < b.length; $++) {
              _ = b[$]
              for (
                var C = String(_[0]), L = c(l(s(_.index), h.length), 0), w = [], S = 1;
                S < _.length;
                S++
              )
                w.push(void 0 === (k = _[S]) ? k : String(k))
              var O = _.groups
              if (p) {
                var j = [C].concat(w, L, h)
                void 0 !== O && j.push(O)
                var A = String(e.apply(void 0, j))
              } else A = g(C, h, L, w, O, e)
              L >= y && ((x += h.slice(y, L) + A), (y = L + C.length))
            }
            return x + h.slice(y)
          }
        ]
        function g(t, e, i, a, s, o) {
          var u = i + t.length,
            c = a.length,
            l = p
          return (
            void 0 !== s && ((s = r(s)), (l = h)),
            n.call(o, l, function(n, r) {
              var o
              switch (r.charAt(0)) {
                case '$':
                  return '$'
    ...
    function(t, e, n) {
      ...
      var i = n(232),
        r = {
          ...
          components: { DropdownTransition: n(255).a },
          beforeCreate: function() {
            this.$options.components.SidebarLinks = n(254).default
          },
      ...
      var c = {
        ...
        render: function(t, e) {
          var n = e.parent,
            ...
            f = l.item,
            h = l.sidebarDepth,
            p = Object(i.e)(a, f.path),
            d =
              'auto' === f.type
                ? p ||
                  f.children.some(function(t) {
                    return Object(i.e)(a, f.basePath + '#' + t.slug)
                  })
                : p,
            g =
              'external' === f.type
                ...
                : o(t, f.path, f.title || f.path, d),
            v = [r.frontmatter.sidebarDepth, h, c.sidebarDepth, s.sidebarDepth, 1].find(function(
              t
            ) {
              return void 0 !== t
            }),
            m = c.displayAllHeaders || s.displayAllHeaders
          return 'auto' === f.type
            ? [g, u(t, f.children, f.basePath, a, v)]
            : (d || m) && f.headers && !i.d.test(f.path)
            ? [g, u(t, Object(i.c)(f.headers), f.path, a, v)]
            : g
        }
      }
      n(296)
      function l(t, e) {
        return (
          ...
          e.children.some(function(e) {
            return 'group' === e.type ? l(t, e) : 'page' === e.type && Object(i.e)(t, e.path)
          })
        )
      }
      var f = {
    ...
    function(t, e, n) {
      ...
      if (
        ...
        (!d ||
          n(4)(function() {
            return (p[n(3)('match')] = !1), c(h) != h || c(p) == p || '/a/i' != c(h, 'i')
          }))
      ) {
        c = function(t, e) {
          var n = this instanceof c,
            i = o(t),
            a = void 0 === e
          return !n && i && t.constructor === c && a
            ? t
            : r(
                d
                  ? new l(i && !a ? t.source : t, e)
                  : l((i = t instanceof c) ? t.source : t, i && a ? u.call(t) : e),
                n ? this : f,
                c
              )
        }
        for (
          ...
          g(v[m++])
        ;(f.constructor = c), (c.prototype = f), n(27)(i, 'RegExp', c)
      }
      n(263)('RegExp')
    },
    function(t, e, n) {
    ...
    function(t, e, n) {
      n(266), (t.exports = n(25).Array.isArray)
    },
    function(t, e, n) {
      var i = n(47)
      i(i.S, 'Array', { isArray: n(132) })
    },
    function(t, e, n) {
      t.exports = n(268)
    },
    function(t, e, n) {
      n(122), n(269), (t.exports = n(25).Array.from)
    },
    function(t, e, n) {
      'use strict'
      var i = n(129),
        ...
        'Array',
        {
          from: function(t) {
            var e,
              ...
              b = l(h)
            if (
              (v && (g = i(g, d > 2 ? arguments[2] : void 0, 2)), null == b || (p == Array && o(b)))
            )
              for (n = new p((e = u(h.length))); e > m; m++) c(n, m, v ? g(h[m], m) : h[m])
            else
              for (f = b.call(h), n = new p(); !(r = f.next()).done; m++)
                c(n, m, v ? s(f, g, [r.value, m], !0) : r.value)
            return (n.length = m), n
          }
        }
      )
    ...
    function(t, e, n) {
      n(131), n(122), (t.exports = n(277))
    },
    function(t, e, n) {
      var i = n(250),
        r = n(20)('iterator'),
        a = n(46)
      t.exports = n(25).isIterable = function(t) {
        var e = Object(t)
    ...
    function(t, e, n) {
      var i = n(285),
        ...
        s = '[object String]'
      t.exports = function(t) {
        return 'string' == typeof t || (!r(t) && a(t) && i(t) == s)
      }
    },
    function(t, e, n) {
      var i = n(253),
      ...
      t.exports = function(t) {
        return null == t ? (void 0 === t ? o : s) : u && u in Object(t) ? r(t) : a(t)
      }
    },
    function(t, e, n) {
      var i = n(287),
    ...
    function(t, e, n) {
                ...
                if (t) {
                  for (
                    var e = this.$site.pages,
                      ...
                      i = this.$localePath,
                      r = function(e) {
                        return e && e.title && e.title.toLowerCase().indexOf(t) > -1
                      },
                      a = [],
                      s = 0;
                    s < e.length && !(a.length >= n);
                    s++
                  ) {
                    var o = e[s]
                    if (this.getPageLocalePath(o) === i && this.isSearchable(o))
                      if (r(o)) a.push(o)
                        ...
                        for (var u = 0; u < o.headers.length && !(a.length >= n); u++) {
                          var c = o.headers[u]
                          r(c) &&
                            a.push(Object.assign({}, o, { path: o.path + '#' + c.slug, header: c }))
                        }
                  }
                  return a
                }
      ...
      function b(t) {
        return (
          ...
          (function(t) {
            if (m()(Object(t)) || '[object Arguments]' === Object.prototype.toString.call(t))
              return g()(t)
          })(t) ||
          (function() {
      ...
      var _ = n(255),
        ...
        x = n.n(k),
        y = {
          components: { NavLink: s, DropdownTransition: _.a },
          data: function() {
            return { open: !1 }
          },
          props: { item: { required: !0 } },
            ...
            computed: {
              ...
              nav: function() {
                ...
                if (e && Object.keys(e).length > 1) {
                  ...
                  return [].concat(b(this.userNav), [a])
                }
                return this.userNav
              },
              userLinks: function() {
      ...
      var w = {
          components: { SidebarButton: f, NavLinks: C, SearchBox: l, AlgoliaSearchBox: {} },
          data: function() {
            return { linksWrapMaxWidth: null }
          },
          mounted: function() {
            var t = this,
              e = parseInt(L(this.$el, 'paddingLeft')) + parseInt(L(this.$el, 'paddingRight')),
              n = function() {
        ...
        P = {
          ...
          computed: {
            prev: function() {
              return D(N.PREV, this)
            },
            next: function() {
              return D(N.NEXT, this)
            }
          }
        }
      var N = {
      ...
      function D(t, e) {
        var n = e.$themeConfig,
          ...
          h = l(r),
          p = j()(h) ? f : h
        return !1 === p ? void 0 : T()(p) ? Object(i.k)(s.pages, p, a.path) : u(r, o)
      }
      function U(t, e, n) {
        var i = []
        !(function t(e, n) {
      ...
      var H = P,
                                ...
                                [
                                  ...
                                  t.prev
                                    ? n(
                                        ...
                                        [t._v(t._s(t.prev.title || t.prev.path))]
                                      )
                                    : t._e()
                                ],
                                1
                                ...
                                [
                                  t.next
                                    ? n('router-link', { attrs: { to: t.next.path } }, [
                                        t._v(t._s(t.next.title || t.next.path))
                                      ])
                                    : t._e(),
                                  t._v('\n      →\n    ')
                                ],
        ...
        W = {
          name: 'Sidebar',
          components: { SidebarLinks: n(254).default, NavLinks: C },
          props: ['items']
        },
        G =
          (n(297),
